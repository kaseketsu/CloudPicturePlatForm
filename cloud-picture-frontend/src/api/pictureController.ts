...
export async function getPictureByIdUsingGet(
  ...
  return request<API.BaseResponsePictures_>('/api/picture/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listPictureByPageUsingPost(
  ...
  return request<API.BaseResponsePagePictures_>('/api/picture/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchPictureByPictureUsingPost(
  ...
  return request<API.BaseResponseListImageResult_>('/api/picture/search/picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** uploadPicture POST /api/picture/upload/file */
export async function uploadPictureUsingPost(
  ...
  return request<API.BaseResponsePictureVO_>('/api/picture/upload/file', {
    method: 'POST',
    params: {
      ...params,
    },
